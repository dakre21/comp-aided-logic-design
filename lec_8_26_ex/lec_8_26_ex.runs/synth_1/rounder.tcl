...
read_verilog -library xil_defaultlib /home/dakre/comp-aided-logic-design/lec_8_26_ex/lec_8_26_ex.srcs/sources_1/new/rounder.v
...
synth_design -top rounder -part xc7a100tcsg324-1


write_checkpoint -force -noxdef rounder.dcp

catch { report_utilization -file rounder_utilization_synth.rpt -pb rounder_utilization_synth.pb }
