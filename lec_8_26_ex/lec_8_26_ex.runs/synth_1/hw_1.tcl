...
read_verilog -library xil_defaultlib /home/dakre/comp-aided-logic-design/lec_8_26_ex/lec_8_26_ex.srcs/sources_1/new/hw_1.v
...
synth_design -top hw_1 -part xc7a100tcsg324-1


write_checkpoint -force -noxdef hw_1.dcp

catch { report_utilization -file hw_1_utilization_synth.rpt -pb hw_1_utilization_synth.pb }
