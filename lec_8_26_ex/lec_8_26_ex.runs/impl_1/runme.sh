...
HD_PWD='/home/dakre/comp-aided-logic-design/lec_8_26_ex/lec_8_26_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rounder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rounder.tcl -notrace
