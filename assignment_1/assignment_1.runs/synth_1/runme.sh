...
HD_PWD='/home/dakre/comp-aided-logic-design/assignment_1/assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuit8.tcl
