...
read_verilog -library xil_defaultlib {
  ...
  /home/dakre/comp-aided-logic-design/assignment_1/assignment_1.srcs/sources_1/new/474a_circuit4.v
}
...
synth_design -top circuit4 -part xc7a100tfgg484-1


write_checkpoint -force -noxdef circuit4.dcp

catch { report_utilization -file circuit4_utilization_synth.rpt -pb circuit4_utilization_synth.pb }
