...
read_verilog -library xil_defaultlib /home/dakre/comp-aided-logic-design/assignment_3/dakre_hlsyn/build/test1.v
...
synth_design -top HLSM -part xc7a100tfgg484-1


write_checkpoint -force -noxdef HLSM.dcp

catch { report_utilization -file HLSM_utilization_synth.rpt -pb HLSM_utilization_synth.pb }
