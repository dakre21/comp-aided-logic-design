...
HD_PWD='/home/dakre/comp-aided-logic-design/assignment_1/assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circuit3.tcl -notrace
