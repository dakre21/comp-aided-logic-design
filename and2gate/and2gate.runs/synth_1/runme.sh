...
HD_PWD='/home/dakre/comp_aided_logic_design/and2gate/and2gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and2gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and2gate.tcl
